        ...
        <div class="card">
          ...
          <div class="card-body">
              <div class="basic-form">
                <form method="POST" action="{{route('simpansupplier')}}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <section class="base">
                    <div class="mb-3">
                      <input type="text" name="nama" id="nama" autofocus="" required="" class="form-control input-default " placeholder="Nama Supplier (PT/Company)">
                  </div>
                    <div class="mb-3">
                     <input type="text" id="alamat" name="alamat" required="" class="form-control input-default " placeholder="Alamat"/>
                    </div>
                    <div class="mb-3">
                     <input type="text" id="notelp" name="notelp" required=""class="form-control input-default " placeholder="No telepon"/>
                    </div>
                    <div class="mb-3">
