        ...
        <div class="card">
          <div class="card-body">
              <div class="container my-4">
                <a href="{{route('tambahsupplier')}}" class="btn btn-square btn-primary mb-3">+ &nbsp; Tambah Supplier</a>
                    ...
                    <tr> 
                     @foreach ($dtSup as $item)
                         <tr>
                          ...
                          <td>{{ $item->notelp}}</td>
                          <td>
                            <a href="{{url('editsupplier', $item->id)}}" class="btn btn-primary shadow btn-xs sharp me-1">
                              <i class="fas fa-pencil-alt"></i>
                            </a>
                            <a href="{{url('hapussupplier', $item->id)}}" class="btn btn-danger shadow btn-xs sharp">
