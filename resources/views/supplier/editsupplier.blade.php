        ...
        <div class="card">
          ...
          <div class="card-body">
              <div class="basic-form">
                <form method="POST" action="{{route('updatesupplier',$dtSup->id)}}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <section class="base">
                    <div>
                      <label>Nama Supplier (PT/Company)</label>
                      <input type="text" name="nama" id="nama"  value="{{ $dtSup->nama }}" class="form-control input-default mb-3 "  autofocus="" required="" />
                    </div>
                    <div>
                      <label>Alamat </label>
                     <input type="text" id="alamat" name="alamat" value="{{$dtSup->alamat}}" required="" class="form-control input-default mb-3"  />
                    </div>
                    <div>
                      <label> No telepon</label>
                     <input type="text" id="notelp" name="notelp" value="{{$dtSup->notelp}}" required="" class="form-control input-default mb-3"/>
                    </div>
                    <div>
