        ...
        <div class="card">
          <div class="card-body">
              <div class="container my-4">
                <a href="{{route('tambahpegawai')}}" class="btn btn-square btn-primary mb-3">+ &nbsp; Tambah Pegawai</a>
                    ...
                    <tr>
                     ...
                     @foreach ($dtPeg as $item)
                         <tr>
                          ...
                          <td>{{ $item->jabatan}}</td>
                          <td>
                            <a href="{{url('editpegawai', $item->id)}}" class="btn btn-primary shadow btn-xs sharp me-1">
                              <i class="fas fa-pencil-alt"></i>
                            </a>
                            <a href="{{url('hapuspegawai', $item->id)}}" class="btn btn-danger shadow btn-xs sharp">
