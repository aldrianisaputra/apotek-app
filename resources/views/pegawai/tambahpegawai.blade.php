          ...
          <div class="card-body">
              <div class="basic-form">
                <form method="POST" action="{{route('simpanpegawai')}}" enctype="multipart/form-data">
                  ...
                  <section class="base">
                    <div class="mb-3">
                      <input type="text" name="nama" id="nama" autofocus="" required="" class="form-control input-default " placeholder="nama pegawai">
                  </div>
                    <div class="mb-3">
                     <input type="text" id="jk" name="jk" required="" class="form-control input-default " placeholder="jenis kelamin"/>
                    </div>
                    <div class="mb-3">
                     <input type="text" id="alamat" name="alamat" required=""class="form-control input-default " placeholder="alamat"/>
                    </div>
                    <div class="mb-3">
                     <input type="text"  id="jabatan" name="jabatan" required="" class="form-control input-default " placeholder="jabatan" />
                    </div>
                    <div class="mb-3">
