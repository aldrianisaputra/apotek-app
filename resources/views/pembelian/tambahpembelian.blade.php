        ...
        <div class="card">
          ...
          <div class="card-body">
              <div class="basic-form">
                <form method="POST" action="{{route('simpanpembelian')}}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <section class="base">
                    <div class="mb-3">
                        <input type="date"  id="tgl_pembelian" name="tgl_pembelian" required="" class="form-control input-default " />
                       </div>
                    <div class="mb-3">
                     <input type="text" id="id_supplier" name="id_supplier" required="" class="form-control input-default " placeholder="Id Supplier"/>
                    </div>
                    <div class="mb-3">
                     <input type="text" id="id_obat" name="id_obat" required=""class="form-control input-default " placeholder="Id Obat"/>
                    </div>
                    <div class="mb-3">
                        <input type="text"  id="qty" name="qty" required="" class="form-control input-default " placeholder="Quantity" />
                    </div>
                    <div class="mb-3">
                        <input type="text"  id="harga_beli" name="harga_beli" required="" class="form-control input-default " placeholder="Harga Beli" />
                    </div>
                    <div class="mb-3">
