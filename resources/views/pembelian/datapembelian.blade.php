...
<head>
  ...
  <link rel="stylesheet" href="{{asset('AdminLTE2/vendor/owl-carousel/owl.carousel.css')}}">
   ...
   <!-- Datatable -->
   <link href="{{asset('AdminLTE2/vendor/datatables/css/jquery.dataTables.min.css')}}" rel="stylesheet">
   <!-- Custom Stylesheet -->
   <link href="{{asset('AdminLTE2/vendor/jquery-nice-select/css/nice-select.css')}}" rel="stylesheet">
   <link href="{{asset('AdminLTE2/css/style.css')}}" rel="stylesheet">
	<!-- Style css -->
...
<body>
        ...
        <div class="content-body">
          ...
          <div class="card-body">
              <div class="container my-4">
                <a href="{{route('tambahpembelian')}}" class="btn btn-square btn-primary mb-3">+ &nbsp; Input Pembelian</a>
                    ...
                    <tr>
                     ...
                     @foreach ($dtBeli as $item)
                         <tr>
                          ...
                          <td>
                            <a href="{{url('editobat', $item->id)}}" class="btn btn-primary shadow btn-xs sharp me-1">
                              <i class="fas fa-pencil-alt"></i>
                            </a>
                            <a href="{{url('hapusobat', $item->id)}}" class="btn btn-danger shadow btn-xs sharp">
                            ...
                            <tr>
                                @foreach ($dtBeli as $item)
                                    <tr>
                                     ...
                                     <td>{{ $item->harga_beli}}</td>
                                     <td>
                                       <a href="{{url('editpembelian', $item->id)}}" class="btn btn-primary shadow btn-xs sharp me-1">
                                         <i class="fas fa-pencil-alt"></i>
                                       </a>
                                       <a href="{{url('hapuspembelian', $item->id)}}" class="btn btn-danger shadow btn-xs sharp">
                                         <i class="fa fa-trash"></i>
                                     </a>
                                     </td>
                                    </tr>
  ...
  <script src="{{asset('AdminLTE2/vendor/peity/jquery.peity.min.js')}}"></script>
	...
	<script src="{{asset('AdminLTE2/js/dashboard/dashboard-1.js')}}"></script>
	 ...
	 <!-- Datatable -->
     <script src="{{asset('AdminLTE2/vendor/datatables/js/jquery.dataTables.min.js')}}"></script>
     <script src="{{asset('AdminLTE2/js/plugins-init/datatables.init.js')}}"></script>
 
     <script src="{{asset('AdminLTE2/vendor/jquery-nice-select/js/jquery.nice-select.min.js')}}"></script>
 
     <script src="{{asset('AdminLTE2/js/custom.min.jss')}}"></script>
     ...
     <script src="{{asset('AdminLTE2/vendor/owl-carousel/owl.carousel.js')}}"></script>
