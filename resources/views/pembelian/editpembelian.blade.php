        ...
        <div class="card">
          ...
          <div class="card-body">
              <div class="basic-form">
                <form method="POST" action="{{route('updatepembelian',$dtBeli->id)}}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <section class="base">
                    <div>
                      <label>Tanggal Pembelian</label>
                      <input type="text" name="tgl_pembelian" id="tgl_pembelian"  value="{{ $dtBeli->tgl_pembelian }}" class="form-control input-default mb-3 " autofocus="" required="" />
                    </div>
                    <div>
                      <label>Id Supplier </label>
                     <input type="text" id="id_supplier" name="id_supplier" value="{{$dtBeli->id_supplier}}" required="" class="form-control input-default mb-3"  />
                    </div>
                    <div>
                      <label> Id Obat</label>
                     <input type="text" id="id_obat" name="id_obat" value="{{$dtBeli->id_obat}}" required="" class="form-control input-default mb-3" />
                    </div>
                    <div>
                        <label> Quantity</label>
                       <input type="text" id="qty" name="qty" value="{{$dtBeli->qty}}" required="" class="form-control input-default mb-3"/>
                    </div>
                    <div>
                        <label> Harga Beli</label>
                       <input type="text" id="harga_beli" name="harga_beli" value="{{$dtBeli->harga_beli}}" required="" class="form-control input-default mb-3"/>
                      </div>
