        ...
        <div class="card">
          ...
          <div class="card-body">
              <div class="basic-form">
                <form method="POST" action="{{route('simpanpenjualan')}}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <section class="base">
                    <div class="mb-3">
                     <input type="text" id="id_pegawai" name="id_pegawai" required="" class="form-control input-default " placeholder="Id Pegawai"/>
                    </div>
                    <div class="mb-3">
                     <input type="text" id="id_obat" name="id_obat" required=""class="form-control input-default " placeholder="Id Obat"/>
                    </div>
                    <div class="mb-3">
                     <input type="date"  id="tgl_penjualan" name="tgl_penjualan" required="" class="form-control input-default " />
                    </div>
                    <div class="mb-3">
                        <input type="text"  id="qty" name="qty" required="" class="form-control input-default " placeholder="Quantity" />
                    </div>
                    <div class="mb-3">
                        <input type="text"  id="harga_jual" name="harga_jual" required="" class="form-control input-default " placeholder="Harga Jual" />
                    </div>
                    <div class="mb-3">
