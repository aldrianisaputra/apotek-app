        ...
        <div class="card">
          <div class="card-body">
              <div class="container my-4">
                <a href="{{route('tambahpenjualan')}}" class="btn btn-square btn-primary mb-3">+ &nbsp; Input Penjualan</a>
                    ...
                    <tr>
                     ...
                     @foreach ($dtJual as $item)
                         <tr>
                          ...
                          <td>
                            <a href="{{url('editpenjualan', $item->id)}}" class="btn btn-primary shadow btn-xs sharp me-1">
                              <i class="fas fa-pencil-alt"></i>
                            </a>
                            <a href="{{url('hapuspenjualan', $item->id)}}" class="btn btn-danger shadow btn-xs sharp">
