        ...
        <div class="card">
          ...
          <div class="card-body">
              <div class="basic-form">
                <form method="POST" action="{{route('updatepenjualan',$dtJual->id)}}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <section class="base">
                    <div>
                      <label>Id Pegawai</label>
                      <input type="text" name="id_pegawai" id="id_pegawai"  value="{{ $dtJual->id_pegawai }}" class="form-control input-default " autofocus="" required="" />
                    </div>
                    <div>
                      <label>Id Obat </label>
                     <input type="text" id="id_obat" name="id_obat" value="{{$dtJual->id_obat}}" required="" class="form-control input-default "  />
                    </div>
                    <div>
                      <label> Tanggal Penjualan</label>
                     <input type="date" id="tgl_penjualan" name="tgl_penjualan" value="{{$dtJual->tgl_penjualan}}" required="" class="form-control input-default "/>
                    </div>
                    <div>
                        <label> Quantity</label>
                       <input type="text" id="qty" name="qty" value="{{$dtJual->qty}}" required="" class="form-control input-default "/>
                    </div>
                    <div>
                        <label> Harga Jual</label>
                       <input type="text" id="harga_jual" name="harga_jual" value="{{$dtJual->harga_jual}}" required="" class="form-control input-default "/>
                      </div>
