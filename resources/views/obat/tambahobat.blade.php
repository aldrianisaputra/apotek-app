        ...
        <div class="card">
          ...
          <div class="card-body">
              <div class="basic-form">
                <form method="POST" action="{{route('simpanobat')}}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <section class="base">
                    <div class="mb-3">
                      <input type="text" name="nama_obat" id="nama_obat" autofocus="" required="" class="form-control input-default " placeholder="nama obat">
                  </div>
                    <div class="mb-3">
                     <input type="file" id="gambar" name="gambar" class="form-file-input form-control" />
                    </div>
                    <div class="mb-3">
                     <input type="text" id="kategori" name="kategori" required="" class="form-control input-default " placeholder="kategori obat"/>
                    </div>
                    <div class="mb-3">
                     <input type="text" id="stock_ready" name="stock_ready" required=""class="form-control input-default " placeholder="stock obat"/>
                    </div>
                    <div class="mb-3">
                     <input type="date"  id="tgl_kadaluarsa" name="tgl_kadaluarsa" required="" class="form-control input-default " placeholder="tanggal kadaluarsa obat" />
                    </div>
                    <div class="mb-3">
                     <input type="text" id="harga" name="harga" required="" class="form-control input-default " placeholder="harga obat" />
                    </div>
                    <div class="mb-3">
