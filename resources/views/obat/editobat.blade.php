        ...
        <div class="card">
          ...
          <div class="card-body">
              <div class="basic-form">
                  <form method="POST" action="{{route('updateobat',$ob->id)}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                      <div class="mb-3">
                          <input type="text" name="nama_obat" id="nama_obat"  value="{{ $ob->nama_obat }}" autofocus="" required="" class="form-control input-default " >
                      </div>
                      <div class="mb-3">
                        <div class="form-file">
                          <input type="file" id="gambar" name="gambar" value="{{$ob->gambar}} class="form-file-input form-control" />
                        </div>
                      </div>
                      </div>
					  <div class="mb-3">
                        <input type="text" id="kategori" name="kategori" value="{{$ob->kategori}}"  required="" class="form-control input-default ">
                      </div>
                      <div class="mb-3">
                        <input type="text" id="stock_ready" name="stock_ready" value="{{$ob->stock_ready}}"  required="" class="form-control input-default ">
                      </div>
                      <div class="mb-3">
                        <input type="text" id="tgl_kadaluarsa" name="tgl_kadaluarsa" value="{{$ob->tgl_kadaluarsa}}" required="" class="form-control input-default " >
                      </div>
                      <div class="mb-3">
                        <input type="text" id="harga" name="harga" value="{{$ob->harga}}"  class="form-control input-default ">
                      </div>
                      <div>
                        <button type="submit" name="submit" value="submit" class="btn btn-rounded btn-primary" style="text-align: center">Simpan</button>
                      </div>
                  </form>
              </div>
          </div>
