        ...
        <div class="card tryal-gradient">
          <div class="card-body tryal row">
            <div class="col-xl-7 col-sm-6">
              <h2>Welcome To F apoték</h2>
              <span>"Kesehatan adalah investasi terbaik yang bisa Anda miliki." - Diane Von Furstenberg</span>
            </div>
            <div class="col-xl-5 col-sm-6">
              <img src="{{asset('AdminLTE2/images/chart.png')}}" alt="" class="sd-shape" style="width: 300px">
            </div>
          </div>
        </div>
        </div>
